...
flexlink.byte$(EXE): $(FLEXDLL_SOURCE_FILES) | boot/bin
	...
	$(call RM_F, boot/bin/flexlink$(EXE))
	$(call CAT_TO, boot/ocamlruns$(EXE) flexlink.byte$(EXE), boot/bin/flexlink$(EXE))
	$(call CP, $(addprefix $(FLEXDLL_SOURCES)/, $(FLEXDLL_OBJECTS)), boot/bin/)
...
flexlink.opt$(EXE): $(FLEXDLL_SOURCE_FILES)
	...
	$(call RM_F, boot/bin/flexlink$(EXE))
	$(call LN_IN, boot/bin, ../../$@, flexlink$(EXE))
