...
ifeq "$(NATIVE_COMPILER)" "true"
	$(call INSTALL_ITEM, ocamlc, bin, , ocamlc.byte$(EXE))
else
	$(call INSTALL_ITEM, ocamlc, bin, , ocamlc.byte$(EXE), ocamlc$(EXE))
endif
endif
...
ifeq "$(NATIVE_COMPILER)" "true"
	...
	$(call INSTALL_ITEM, boot/flexlink.byte$(EXE), bin, , , flexlink$(EXE))
endif
