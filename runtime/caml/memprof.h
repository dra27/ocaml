...
CAMLextern void caml_memprof_init_th_ctx(struct caml_memprof_th_ctx* ctx);
CAMLextern void caml_memprof_stop_th_ctx(struct caml_memprof_th_ctx* ctx);
CAMLextern void caml_memprof_save_th_ctx(struct caml_memprof_th_ctx* ctx);
CAMLextern void caml_memprof_restore_th_ctx(const struct caml_memprof_th_ctx* ctx);
