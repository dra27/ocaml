...
CAMLextern int caml_multi_byte_to_wide_char(const char* s,
                                            int slen,
                                            wchar_t *out,
                                            int outlen);
CAMLextern int caml_wide_char_to_multi_byte(const wchar_t* s,
                                            int slen,
                                            char *out,
                                            int outlen);

/* Legacy names */
#define win_multi_byte_to_wide_char caml_multi_byte_to_wide_char
#define win_wide_char_to_multi_byte caml_wide_char_to_multi_byte
