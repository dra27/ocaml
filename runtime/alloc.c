...
/* This has to be done with a macro, rather than an inline function, since
   ...
   breaks MSVC. */
#define Do_alloc_small_aux(wosize, tag, ...)            \
{                                                       \
  Caml_check_caml_state();                              \
  value v;                                              \
