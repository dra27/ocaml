...
Caml_inline wchar_t *char_array_to_utf16(const char *s,
...
{
  return char_array_to_utf16(s, -1, NULL);
}

CAMLexport wchar_t *caml_stat_char_array_to_utf16(const char *s, size_t size,
                                                  size_t *out_size)
{
  return char_array_to_utf16(s, size, out_size);
}

Caml_inline caml_stat_string char_array_of_utf16(const wchar_t *s, int slen,
                                                 size_t *out_size)
{
...
{
  return char_array_of_utf16(s, -1, NULL);
}
...
CAMLexport caml_stat_string caml_stat_char_array_of_utf16(const wchar_t *s,
                                                          ...
                                                          size_t *out_size)
{
  return char_array_of_utf16(s, size, out_size);
}
