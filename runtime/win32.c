...
static struct error_entry win_error_table[] = {
  ...
  { ERROR_NO_UNICODE_TRANSLATION, 0, EILSEQ },
  { ERROR_NOT_ENOUGH_QUOTA, 0, ENOMEM },
  { ERROR_INVALID_STARTING_CODESEG,
    ERROR_INFLOOP_IN_RELOC_CHAIN - ERROR_INVALID_STARTING_CODESEG,
    ENOEXEC },
  /* STL has the follow different mappings:
       ERROR_BAD_UNIT -> ENODEV
       ERROR_NOT_READY -> EAGAIN
       ERROR_SEEK, ERROR_READ_FAULT, ERROR_WRITE_FAULT -> EIO */
  { ERROR_WRITE_PROTECT,
  ...
  /* STL mappings from stl/src/syserrno.cpp */
  { ERROR_BUFFER_OVERFLOW, 0, ENAMETOOLONG },
  { ERROR_BUSY_DRIVE, 0, EBUSY },
  { ERROR_CANTOPEN, 0, EIO },
  { ERROR_CANTREAD, 0, EIO },
  { ERROR_CANTWRITE, 0, EIO },
  { ERROR_DEV_NOT_EXIST, 0, ENODEV },
  { ERROR_DEVICE_IN_USE, 0, EBUSY },
  { ERROR_DIRECTORY, 0, EINVAL },
  { ERROR_HANDLE_DISK_FULL, 0, ENOSPC },
  { ERROR_INVALID_NAME, 0, ENOENT },
  { ERROR_LOCKED, 0, ENOLCK },
  { ERROR_NOACCESS, 0, EACCES },
  { ERROR_NOT_SUPPORTED, 0, ENOTSUP },
  { ERROR_OPEN_FAILED, 0, EIO },
  { ERROR_OPEN_FILES, 0, EBUSY },
  { ERROR_OPERATION_ABORTED, 0, ECANCELED },
  { ERROR_OUTOFMEMORY, 0, ENOMEM },
  { ERROR_REPARSE_TAG_INVALID, 0, EINVAL },
  { ERROR_RETRY, 0, EAGAIN },
  { 0, -1, 0 }
};
