...
void caml_debuginfo_location(debuginfo dbg, /*out*/ struct caml_loc_info * li)
{
  ...
  /* Format of the two info words:
     Two possible formats based on value of bit 63 (p):
     ...
     Fully packed format:
       |-------------- info2 ------------||------------- info1 -------------|
       0 llllllllllllmmmaaaa aabbbbbb booooooooo ffffffffffffffffffffffff k n
                         44       36    |    26                        2 1 0
                       (32+12)    (32+4)
     ...
     f (   24 bits): offset (in 4-byte words) of struct relative to dbg. For
                     partially packed format, f is struct name_with_loc_info;
