...
CAMLprim value caml_gr_draw_arc_nat(value vx, value vy, value vrx, value vry, value vstart, value vend)
{
...
#if 0
/* doesn't seem to be used - and wrong anyway.
   the first parameter if of type char * not value */
...
CAMLprim value caml_gr_fill_arc_nat(value vx,value vy,value vrx,value vry,value vstart,value vend)
{
