...
val with_standard_handlers : ('a -> 'b) -> 'a -> 'b
(** [with_standard_handlers f v] evaluates [f v] but handles any effects
    performed by the compiler library:

    - {!Load_path.Dir} is mapped to {!Sys.readdir} *)
