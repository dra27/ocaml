...
let model = "default"
let system = Config_constants.System.S_unknown
let abi = "default"
...
let ext_exe =
  ".ex_The boot compiler should not be using Config_settings.ext_exe"
let ext_obj = ".o_The boot compiler cannot process C objects"
let ext_asm = ".s_The boot compiler should not be using Config_settings.ext_asm"
