  ...
  | Uprim(prim, args, dbg) ->
      ...
      | (Pintcomp _ as comp,
         [Uprim(Pccall { prim_name = "caml_int_compare"; _ },
                ...
                _);
          Uconst(Uconst_int 0)]) ->
          transl_prim_2 env comp arg1 arg2 dbg
      | (Pintcomp comp,
         [Uprim(Pccall { prim_name = ("caml_int32_compare"
                ...
                _);
          Uconst(Uconst_int 0)]) ->
          transl_prim_2 env (Pbintcomp (Pint32, comp)) arg1 arg2 dbg
      | (Pintcomp comp,
         [Uprim(Pccall { prim_name = ("caml_int64_compare"
                ...
                _);
          Uconst(Uconst_int 0)]) ->
          transl_prim_2 env (Pbintcomp (Pint64, comp)) arg1 arg2 dbg
      | (Pintcomp comp,
         [Uprim(Pccall { prim_name = ("caml_nativeint_compare"
                ...
                _);
          Uconst(Uconst_int 0)]) ->
          transl_prim_2 env (Pbintcomp (Pnativeint, comp)) arg1 arg2 dbg
      | (p, [arg]) ->
